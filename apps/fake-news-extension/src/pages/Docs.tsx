...
const Docs = () => {
  ...
  "status": "success"
      ...
      javascriptExample: `fetch('https://api.verinews.com/api/claims/verify', {
  method: 'POST',
  headers: {
...
url = "https://api.verinews.com/api/claims/verify"
data = {
    "claim": "SpaceX launched a new internet satellite with fast speed."
}
...
print(result)`,
      curlExample: `curl -X POST "https://api.verinews.com/api/claims/verify" \\
  ...
  "status": "success"
      ...
      javascriptExample: `fetch('https://api.verinews.com/api/analysis/analyze', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
  },
...
url = "https://api.verinews.com/api/analysis/analyze"
data = {
    "claim": "COVID-19 vaccines cause infertility",
    "articles": [...]
}
...
response = requests.post(url, json=data)
result = response.json()`,
      curlExample: `curl -X POST "https://api.verinews.com/api/analysis/analyze" \\
  -H "Content-Type: application/json" \\
  -d '{
    "claim": "COVID-19 vaccines cause infertility",
    "articles": [...]
  ...
  "pagination": {
    ...
    "pages": 15
      ...
      javascriptExample: `fetch('https://api.verinews.com/public/claims?page=1&limit=10')
  .then(response => response.json())
  .then(data => console.log(data));`,
      pythonExample: `import requests

url = "https://api.verinews.com/public/claims"
params = {"page": 1, "limit": 10}

response = requests.get(url, params=params)
result = response.json()`,
      curlExample: `curl "https://api.verinews.com/public/claims?page=1&limit=10"`,
      parameters: [
  ...
  "pagination": {
    ...
    "pages": 5
      ...
      javascriptExample: `fetch('https://api.verinews.com/public/claims/by-category/science?page=1&limit=10')
  .then(response => response.json())
  .then(data => console.log(data));`,
      pythonExample: `import requests

url = "https://api.verinews.com/public/claims/by-category/science"
params = {"page": 1, "limit": 10}

response = requests.get(url, params=params)
result = response.json()`,
      curlExample: `curl "https://api.verinews.com/public/claims/by-category/science?page=1&limit=10"`,
      parameters: [
  ...
  "pagination": {
    ...
    "pages": 5
      ...
      javascriptExample: `fetch('https://api.verinews.com/public/sources?page=1&limit=10')
  .then(response => response.json())
  .then(data => console.log(data));`,
      pythonExample: `import requests

url = "https://api.verinews.com/public/sources"
params = {"page": 1, "limit": 10}

response = requests.get(url, params=params)
result = response.json()`,
      curlExample: `curl "https://api.verinews.com/public/sources?page=1&limit=10"`,
      parameters: [
        { name: "page", type: "number", required: false, description: "Page number (default: 1)" },
        { name: "limit", type: "number", required: false, description: "Items per page (default: 10)" }
      ]
  ...
  "pagination": {
    ...
    "pages": 20
      ...
      javascriptExample: `fetch('https://api.verinews.com/public/analyses?page=1&limit=10')
  .then(response => response.json())
  .then(data => console.log(data));`,
      pythonExample: `import requests

url = "https://api.verinews.com/public/analyses"
params = {"page": 1, "limit": 10}

response = requests.get(url, params=params)
result = response.json()`,
      curlExample: `curl "https://api.verinews.com/public/analyses?page=1&limit=10"`,
      parameters: [
        { name: "page", type: "number", required: false, description: "Page number (default: 1)" },
        { name: "limit", type: "number", required: false, description: "Items per page (default: 10)" }
      ]
    },
    {
      ...
      javascriptExample: `fetch('https://api.verinews.com/api/export/claims')
...
url = "https://api.verinews.com/api/export/claims"
response = requests.get(url)

with open('data_management_system_claims.csv', 'wb') as f:
    f.write(response.content)`,
      curlExample: `curl "https://api.verinews.com/api/export/claims" \\
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex max-w-7xl mx-auto">
        {/* Enhanced Sidebar */}
        <aside className="w-72 min-h-screen bg-surface/30 border-r border-border p-6 sticky top-20 hidden lg:block">
          <nav className="space-y-6">
            <div>
              <h3 className="font-semibold text-primary-text mb-4">Quick Navigation</h3>
              <ul className="space-y-2">
                <li>
                  <button 
                    onClick={() => scrollToSection('overview')} 
                    className="text-muted-text hover:text-primary transition-colors text-left"
                  >
                    Overview
                  </button>
                </li>
            ...
            <div>
              <h3 className="font-semibold text-primary-text mb-4">Free Services</h3>
                ...
                {endpoints.map((endpoint) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full flex items-center gap-3 p-2 rounded-lg hover:bg-muted/20 transition-colors group text-left"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {endpoint.exportCSV && <Badge className="bg-accent/10 text-accent text-xs">CSV</Badge>}
                        </div>
                        <p className="text-sm text-primary-text group-hover:text-primary transition-colors truncate">
                          {endpoint.title}
                        </p>
                        <div className="flex flex-wrap gap-1 mt-1">
                          {endpoint.tags.map((tag) => (
                            <span key={tag} className="text-xs text-muted-text bg-muted/10 px-1.5 py-0.5 rounded">
                              {tag}
                            </span>
                          ))}
                        </div>
          ...
          <section id="endpoints" className="mb-12">
            ...
            <div className="space-y-8">
              {endpoints.map((endpoint) => {
                const Icon = endpoint.icon;
                return (
                  <Card key={endpoint.id} className="border-border bg-surface">
                    <CardHeader>
              ...
              <CardContent>
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="relative">
                      <pre className="bg-muted/10 border border-border rounded-lg p-4 overflow-x-auto text-sm">
                        <code className="text-muted-text">{`curl -X POST "https://api.verinews.com/api/claims/verify" \\
  -H "Content-Type: application/json" \\
  -d '{
    "claim": "SpaceX launched a new internet satellite with fast speed."
  }'`}</code>
